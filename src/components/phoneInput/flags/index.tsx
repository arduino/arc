...
export function BQ({ title, ...rest }: flagIcon): React.ReactElement {
  return (
    <svg width="1em" height="1em" viewBox="0 0 512 341.3" {...rest}>
      ...
      <path fill="#0052B4" d="M0 341.3h512V0z" />
      <path fill="#FFDA44" d="M250.4 0H0v166.9z" />
      <path
        fill="#D80027"
...
export function BR({ title, ...rest }: flagIcon): React.ReactElement {
  return (
    <svg width="1em" height="1em" viewBox="0 0 512 341.3" {...rest}>
      ...
      <circle fill="#FFF" cx={256} cy={170.7} r={86.5} />
      <g fill="#0052B4">
...
export function BY({ title, ...rest }: flagIcon): React.ReactElement {
  return (
    <svg width="1em" height="1em" viewBox="0 0 512 341.3" {...rest}>
      ...
      <path fill="#FFF" d="M100.1 230V.2H0v340.9h511.4-411.3z" />
      <path
        fill="#D32424"
...
export function CL({ title, ...rest }: flagIcon): React.ReactElement {
  return (
    <svg width="1em" height="1em" viewBox="0 85.333 512 341.333" {...rest}>
      {title && <title>{title}</title>}
      <path fill="#D80027" d="M0 85.337h512v341.326H0z" />
      <path fill="#FFF" d="M256 85.337h256V256H256z" />
...
export function CV({ title, ...rest }: flagIcon): React.ReactElement {
  return (
    <svg width="1em" height="1em" viewBox="0 0 512 341.3" {...rest}>
      ...
      <path fill="#FFF" d="M0 140.8h512v41.4H0zM0 223.6h512V265H0z" />
      <g fill="#FFDA44" stroke="#000" strokeMiterlimit={10}>
...
export function CW({ title, ...rest }: flagIcon): React.ReactElement {
  return (
    <svg width="1em" height="1em" viewBox="0 0 512 341.3" {...rest}>
      {title && <title>{title}</title>}
      <path fill="#0052B4" d="M0 0h512v341.3H0z" />
      <path fill="#FFDA44" d="M0 233.5h512v51H0z" />
      <g fill="#FFF">
...
export function EH({ title, ...rest }: flagIcon): React.ReactElement {
  return (
    <svg width="1em" height="1em" viewBox="0 0 512 341.3" {...rest}>
      ...
      <g fill="#D80027">
        <path d="M256 170.7L0 341.3V0zM309.1 170.7c0-22.9 13.1-42.1 34.6-46.8-3.3-.7-6.7-1.1-10.3-1.1-26.4 0-47.9 21.4-47.9 47.9s21.4 47.9 47.9 47.9c3.5 0 7-.4 10.3-1.1-21.5-4.8-34.6-23.9-34.6-46.8z" />
...
export function KR({ title, ...rest }: flagIcon): React.ReactElement {
  return (
    <svg width="1em" height="1em" viewBox="0 0 513 342" {...rest}>
      ...
      <circle fill="#D80027" cx={255.8} cy={170.7} r={62.3} />
      <path
        fill="#0052B4"
...
export function LR({ title, ...rest }: flagIcon): React.ReactElement {
  return (
    <svg width="1em" height="1em" viewBox="0 85.333 512 341.333" {...rest}>
      {title && <title>{title}</title>}
      <path fill="#FFF" d="M0 91.476h512v341.337H0z" />
      <g fill="#D80027">
